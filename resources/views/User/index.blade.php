        ...
        <div class="container">
            <div class="newsfeed newsfeed1">
                ...
                <div class="newsfeed-div newsfeed-content">
                    <a href="{{ route('Show', $newsfeed->id) }}"><p class= "text-left"> 
                        {{$newsfeed->title}}
                    </p></a>
         ...
         <div class="container">
            ...
            <div class="row">
                ...
                @if ($key==1)
                    ...
                    <div class="card">
                        <div class="card-img">
                            <img src="{{url($trending->imgTrending)}}" class="img-fluid">
                        </div>
                        <div class="card-body">
                            <h4 class="card-title">{{$trending->title}}</h4>
                            <p> {!!$trending->mytextarea!!}</p>
                        </div>
